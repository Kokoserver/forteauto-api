...
from fortauto.api.payment import payment_model
from fortauto.api.payment import payment_schema
from fortauto.core.authentication import UserWrite
from fortauto.api.service import service_model
from fortauto.api.user.address import user_address_model
from fortauto.api import api_base_schema as base_schema
from fortauto.core.payment import rave_payement
from fortauto.core.payment import rave_payment_schema
from fortauto.api.payment import payment_schema
...
async def create_card_payment(paymentDetails: payment_schema.PaymentInput,
    ...
    if not response.flwRef:
        raise HTTPException(status_code=status.HTTP_400_BAD_REQUEST, detail="Invalid card i formation was provided")
    return response
